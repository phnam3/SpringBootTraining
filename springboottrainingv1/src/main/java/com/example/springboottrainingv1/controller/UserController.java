package com.example.springboottrainingv1.controller;

import com.example.springboottrainingv1.entity.Permission;
import com.example.springboottrainingv1.entity.User;
import com.example.springboottrainingv1.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<List<User>> findUserWithHeader(@RequestHeader(name = "permission", required = false) String permission){
        return userService.findUserWithHeader(permission);
    }
